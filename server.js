...
// --- 2. DATABASE CONNECTION IS FIXED HERE ---
// It now uses your Railway environment variables
...
app.post("/marks/bulk", (req, res) => {
  ...
  const query =
    "INSERT INTO marks (student_id, subject, marks_obtained, total_marks, exam_type) VALUES ? ON DUPLICATE KEY UPDATE marks_obtained = VALUES(marks_obtained), total_marks = VALUES(total_marks)";
...
// --- 3. SERVER LISTEN IS FIXED HERE ---
// It now uses the correct host '0.0.0.0' for deployment
